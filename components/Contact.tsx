...
export default function Contact() {
  ...
  const leftFigureY = useTransform(
    scrollYProgress,
    [0, 1],
    prefersReducedMotion ? [0, 0] : [100, -100],
  );
  const rightFigureY = useTransform(
    scrollYProgress,
    [0, 1],
    prefersReducedMotion ? [0, 0] : [50, -150],
  );
  ...
  const socials = [
    ...
    },
    {
      ...
      href: "https://www.linkedin.com/in/adri%C3%A0-guilera-2555881a8/",
      icon: (
        <svg
          className="w-6 h-6"
          fill="currentColor"
  ...
  return (
    <section
      id="contact"
      className="py-16 bg-surface overflow-hidden"
      ref={containerRef}
        ...
        <div className="relative">
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <motion.div variants={itemVariants} className="mb-2">
              <h2 id="contact-heading" className="heading-3 mb-4">
                Let's Connect
              </h2>
              <motion.div
