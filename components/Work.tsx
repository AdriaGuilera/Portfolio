...
export default function Work() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Side projects built for experimentation and learning. Exploring new technologies, testing ideas, and building tools that solve interesting problems or just spark joy.',
      tech: ['Various', 'Experimental', 'Open Source'],
      year: 'Ongoing',
    },
  ]
    ...
    <section id="work" className="section-padding overflow-hidden scroll-mt-20" ref={containerRef} aria-labelledby="work-heading">
      ...
      >
        ...
        <div className="mb-32">
          <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-20 gap-8">
            <motion.div variants={itemVariants}>
              <h2 id="work-heading" className="heading-2 mb-4">Work Experience</h2>
              <motion.div 
          ...
          <div className="grid md:grid-cols-2 gap-8" role="list" aria-label="Work experience">
        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-8" role="list" aria-label="Projects">
